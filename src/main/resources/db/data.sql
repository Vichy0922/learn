...
INSERT INTO `music` (id,songname, singer, content) VALUES ('1', '没有你不行', 'running man', ' ');
INSERT INTO `music` (id,songname, singer, content) VALUES ('2', 'Hollywood', '刘在石 Haha', ' ');
INSERT INTO `music` (id,songname, singer, content) VALUES ('3', 'PARTY', '池石镇 李光洙 A-pink', ' ');
